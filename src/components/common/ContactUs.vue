   ...
   <div class="contact-us bg-white">
      <b-container class="sw-conttainer">
         ...
         <b-row align-h="center" class="sw-form-wrapper bg-white text-center">
            <sw-form class="sw-form" :model="form" :rules="rules" ref="contactUs">
               <b-row>
                  <b-col md="4" class="sw-col">
                     <sw-form-item prop="companyName">
                        <sw-input id="company-name" v-model="form.companyName" autocomplete="off" placeholder="企业名称">
                        </sw-input>
                     </sw-form-item>
                  </b-col>
                  <b-col md="4" class="sw-col">
                     <sw-form-item prop="fullName">
                        <sw-input id="full-name" v-model="form.fullName" placeholder="真实姓名"></sw-input>
                     </sw-form-item>
                  </b-col>
                  <b-col md="4" class="sw-col">
                     <sw-form-item prop="contact">
                        <sw-input id="contact" v-model="form.contact" placeholder="联系方式"></sw-input>
                     </sw-form-item>
                  </b-col>
               </b-row>
               <b-row>
                  <b-col class="sw-col">
                     <sw-form-item prop="content">
                        <sw-input type="textarea" id="content" v-model="form.content" placeholder="咨询内容" rows="6"
                           max-rows="10"></sw-input>
                     </sw-form-item>
                  </b-col>
               </b-row>
               <b-button class="submit py-2" type="submit" variant="primary" @click="onSubmit('contactUs')">提交
               </b-button>
            </sw-form>
         </b-row>
      </b-container>
